...
class CalendarScreen extends Component {
  ...
  selectDay = (selectedDay, { hijriInfo }) => {
    this.setState({
      selectedItem: {
        selectedDay,
        selectedMonth: this.state.check.month()+1,
      ...
      >
        ...
        <View style={{ flex: 5, marginTop: 20 }}>
          ...
          />
            ...
            <PrayersTimesDay key={`${this.state.selectedItem.selectedDay}`} 
            currentMiladiDay={this.state.selectedItem} withoutTimer={true}
            isDayLightSaving={this.props.isDayLightSaving} hideHighlightCurrentSalah={true}
            />
